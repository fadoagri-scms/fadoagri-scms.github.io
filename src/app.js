  ...
  (function(){
    ...
    async function refillTraceFromSystem(silent){
      ...
      try{
        ...
        if(items.length){
          ...
          if(productName) traceProductNameInput.value = productName;
          gotAny = true;
        }
    ...
    async function openTraceModal(batchCode){
      ...
      try{
        ...
        if(!bi.trace_product_name && !bi.trace_region && !bi.trace_packed_date && !bi.trace_packing_text) refillTraceFromSystem(true);
