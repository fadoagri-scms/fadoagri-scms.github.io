...
def main():
    ...
    # Copy ảnh/asset tĩnh (logo...) vào dist/assets — GitHub Action chỉ deploy
    # đúng thư mục dist/, không tự copy file trong src/ sang, nên phải chép
    # tay ở đây thì ảnh mới lên được site thật.
